...
if (isset($_GET['del'])) {
	...
	$_SESSION['msg'] = "eleminado correctamente !!";
}
?>
<!DOCTYPE html>
<html lang="en">
		...
		<div class="app-content">
			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<form role="form" method="post" name="search" action="add-doctor.php" class="formulariob">
											...
											<tr>
												...
												<td>
													<div class="visible-md visible-lg hidden-sm hidden-xs">
														...
														<a href="manage-doctors.php?id=<?php echo $row['id'] ?>&del=delete" onClick="return confirm('Está seguro de que desea eliminar?')" class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove"><i class="fa fa-trash fa fa-white"></i></a>
													</div>
