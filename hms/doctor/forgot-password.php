...
if (isset($_POST['submit'])) {
	...
	if ($row > 0) {
		...
		echo "<script>alert('Detalles no válidos. Por favor, pruebe con detalles válidos');</script>";
	...
	<div class="row">
		<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="logo margin-top-30">
				<a href="../../index.html">
					<h2 style="color: #2dc3cc;font-weight: 600;"> Doctor || Recuperación de contraseña</h2>
				</a>
			</div>
			...
			<div class="box-login">
				<form class="form-login" method="post">
					<fieldset>
						...
						<p>
						Introduzca su número de contacto y correo electrónico para recuperar su contraseña.<br />
						...
						<div class="form-actions">
							...
							<button type="submit" class="btn btn-primary pull-right" name="submit">
								Seguiente <i class="fa fa-arrow-circle-right"></i>
							</button>
						</div>
